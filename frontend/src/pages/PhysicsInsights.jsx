...
export default function PhysicsInsights({ engine }) {
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6 font-sans pb-8">
      ...
      <div className="flex flex-wrap gap-3 bg-slate-900/40 backdrop-blur-md p-5 rounded-[24px] border border-white/10 shadow-2xl relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Panel title="2D Stress Distribution Heatmap" className="lg:col-span-1 flex flex-col items-center justify-center p-6 h-[380px] bg-slate-900/40 backdrop-blur-md border-white/10">
        ...
        <Panel title="CRI Lifecycle Trajectory" className="lg:col-span-1 h-[380px] bg-slate-900/40 backdrop-blur-md border-white/10">
        ...
        <Panel title="Root Cause Attribution" className="lg:col-span-1 h-[380px] bg-slate-900/40 backdrop-blur-md border-white/10">
          <div className="h-full w-full pt-4">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <Panel className="relative overflow-hidden border-white/10 bg-slate-900/40 backdrop-blur-md shadow-2xl p-8 rounded-[32px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 items-center">
          ...
          <div className="lg:col-span-3 space-y-6">
            {STAGE_CONFIG.map((stage) => {
              ...
              return (
                <div key={stage.name} className="border border-white/10 rounded-2xl overflow-hidden bg-white/5 group/stage">
                  <button
                  ...
                  {expandedStage === stage.name && (
                    <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-8 border-t border-white/5 bg-slate-900/60">
